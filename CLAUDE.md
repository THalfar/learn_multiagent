...
- `config/opus_prompts.yaml` — Quad agent prompts with personalities
- `config/duo_prompts.yaml` — Duo prompts: the SHODAN Director (no Manager/Tester, four-gate JSON contract) + the Coder (raw-output paragraph + chat_template)
